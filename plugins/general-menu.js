...
https://chat.whatsapp.com/IbptGVcM4lmKYk7S63sfy1
`
...
let url = `https://telegra.ph/file/581859d4dc0207fab9a0e.jpg`
...
await conn.sendMessage(m.chat, { text: captione, contextInfo: { externalAdReply: { title: conn.user.name, body: 'KILLUA ZOLDYCK', thumbnailUrl: pp, sourceUrl: "https://wa.me/"+ global.owner[0], mediaType: 1, renderLargerThumbnail: true }}})
await apivisit
  } catch (e) {
