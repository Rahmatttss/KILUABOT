...
AntiBot ( ${usedPrefix + command} antibot )
AntiPorn ( ${usedPrefix + command} antiporn )
AntiFoto ( ${usedPrefix + command} antifoto )
AntiVideo ( ${usedPrefix + command} antivideo )
AntiBuleAll ( ${usedPrefix + command} antibuleall )`
