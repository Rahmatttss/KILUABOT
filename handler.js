        ...
        try {
            ...
            if (user) {
                ...
                if (chat) {
                    ...
                    if (!('antiFoto' in chat)) chat.antiFoto = true
                    if (!('antiVideo' in chat)) chat.antiVideo = true
...
global.dfail = (type, m, conn) => {
    ...
    if (msg) return conn.reply(m.chat, msg, { key: { participant: '0@s.whatsapp.net', remoteJid: 'status@broadcast'}, message: { pollCreationMessage: { name: `Simple Bot WhatsApp` } } })
}
